...
function ItemFinanceiroViagem({item, imagem}: ItemViagemProps) {

  const [descricaoTruncada, setDescricaoTruncada] = useState<string>('');
  const navigation = useNavigation<NativeStackNavigationProp<RootStackParamList>>();

  return(
    <TouchableOpacity style={styles.wrapper} onPress={() => {navigation.navigate('FinanceiroViagemSelecionada', {viagem: item})}}>
      {imagem == null ? 
      (<NoImage />)
      : 
      (<Image
...
export default ItemFinanceiroViagem;