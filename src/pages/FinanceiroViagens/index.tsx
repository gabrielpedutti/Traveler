...
import ItemFinanceiroViagem from "../../components/ItemFinanceiroViagem";

function FinanceiroViagens() {
  ...
  const renderItem = ({ item }: { item: GetViagensResponseDto }) => (
    <ItemFinanceiroViagem item={item} />
  );
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <HeaderFixo />
        <Titulo texto="Financeiro - Viagens" />
        <Text style={styles.textSubtitle}>Selecione uma viagem para ver os detalhes financeiros.</Text>
        {isLoading ? (
...
export default FinanceiroViagens;
